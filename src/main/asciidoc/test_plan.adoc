...
- Es ist ein Event, der EventCompany, vorhanden | button auf Eventseite betätigen       |…
|I0020 |Event erstellen |Als EventEmployee eingeloggt | korrekte ausgefülltes Erstell-Form |…
|I0021 |Event erstellen |Als EventEmployee eingeloggt | inkorrekt ausgefülltes Erstell-Form (leerer String, negative Zahl) |…
|I0030 |Ferienhaus erstellen |Als Host eingeloggt  | korrekte ausgefülltes Erstell-Form |…
|I0031 |Ferienhaus erstellen |Als Host eingeloggt  | inkorrekt ausgefülltes Erstell-Form (leerer String, negative Zahl) |…
|I0040 |Events für Häuser bestätigen a| - Als Host eingeloggt  
- Es muss ein Ferienhaus existieren  
- Es muss ein noch nich bestätigtes Event in der Nähe des Ferienhauses existieren  | button auf Hausseite betätigen |…
|I1000 |Ferienhaus buchen a| - Als Tenant eingeloggt  
- Es existieren buchbare Ferienhäuser |korrekt abgeschlossene Buchung |…
|I1001 |Ferienhaus buchen a| - Als Tenant eingeloggt  
- Es existieren buchbare Ferienhäuser |inkorrekte Buchungsparameter (Haus zu dieser Zeit schon gebucht) |…
|I1001 |Ferienhaus buchen a| - Als Tenant eingeloggt  
- Es existieren buchbare Ferienhäuser |inkorrekte Buchungsparameter (Start- und Enddatum in falscher Reihenfolge) |…
|I1010 |Tenant storniert Buchung a| - Als Tenant eingeloggt  
- Es existiert eine Buchung für eine Ferienwohnung  |button auf Buchungsseite betätigen  |…
|I2000 |Registrieren |System wird von unregisteredUser benutzt | korrekte Registierungsdaten eingegeben |…
|I2001 |Registrieren |System wird von unregisteredUser benutzt | inkorrekte Registierungsdaten eingegeben (Account bereits vorhanden) |…
|I2010 |Registrierung bestätigen a| - Admin ist eingeloggt  
- es liegt eine Registrieungsanfrage vor  | Button auf der Tenant-Bestätigungsseite betätigen |…
|I2020 |Anmeldung |System wird von unregisteredUser benutzt | korrekte Logindaten eingegeben  |…
...
|I2030 |Ausloggen |System wird von einem angemeldeten User benutzt | in der Navbar auf loggout drücken |…
|I2040 |Vermieter erstellen |Admin ist eingeloggt | korrekte Daten eingegeben |…
|I2041 |Vermieter erstellen |Admin ist eingeloggt | inkorrekte Daten eingegeben(Benutzer existiert schon) |…
|I2050 |Eventfirma hinzufügen |Admin ist eingeloggt | korrekte Daten eingegeben |…
|I2051 |Eventfirma hinzufügen |Admin ist eingeloggt | inkorrekte Daten eingegeben(Eventfirma existiert schon) |…
|I2060 |Eventmitarbeiter erstellen |Admin ist eingeloggt | korrekte Daten eingegeben |…
|I2061 |Eventmitarbeiter erstellen |Admin ist eingeloggt | inkorrekte Daten eingegeben(Benutzer existiert schon) |…
|…  |…              |…              |…       |…
|===
