...
Wir testen zuerst die einzelne kleinen grundsätzlichen Funktionen in den Klassen, sowie und auch einzelnen Klassen mit JUnit.
Danach gehen wir nach dem Bottom-Up Prinzip vor und testen die die Zusammenhänge der komponenten mit Integrationstests.
