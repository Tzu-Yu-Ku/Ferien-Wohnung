...
Je nachdem welche Zugangsrechte der jeweiligen Nutzer erlangen will, müssen folgende Informationen zur Verfügung gestellt werden:
...
|[F0310]|v0.1|Bestellungen anzeigen a|Das System soll es dem Admin ermöglichen sich eine Liste, mit allen Bestellungen, die über das Systeme erstellt wurden, anzeigen zu lassen.
Die folgenden Daten sollen jeder Bestellung hierbei zugeordnet werden:
