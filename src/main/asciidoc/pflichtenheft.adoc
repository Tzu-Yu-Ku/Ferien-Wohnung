...
image::./models/analysis/Anwendungsfalldiagramm_v1.3.png[Anwendungsfall-Diagramm, 100%, 100%, pdfwidth=100%, title= "Anwendungsfall-Diagramm", align=center]
...
Die folgende Tabelle zeigt welche Qualitätsansprüche zu welchem Grad erfüllt sein müssen
Jede Zeile beschreibt jeweils einen Qualitätsanspruch, wobei das "x" die Wichtung der einzelnen Ansprüche markiert.
...
Sicherheit beschreibt den Umgang mit Accountdaten bzw. personenbezogen Daten, sowie Bankdaten und ähnliches.  
Benutzbarkeit beschreibt wie gut sich Nutzer auf der Seite zurechtfinden und wie benutzerfreundlich die Interaktionsmöglichkeiten sind.
Wartbarkeit beschreibt wie gut sich die Seite intern Verwalten lässt (speziell aus Admin Sicht).
