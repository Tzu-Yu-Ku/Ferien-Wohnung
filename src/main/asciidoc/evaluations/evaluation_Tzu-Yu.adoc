...
Ich habe mich zum erstenmal intensiv mit einer Objektorientierten Sprache auseinander gesetzt, das
hat mir sehr geholfen die recht abstrakten Prinzipen aus der Softwaretechnologie-Vorlesung besser zu
...
gesamten Projekt. Zu dem hätte ich noch eine kurze erklärungen zu kleineren schon angefertigten Dateien wie der pom.xml
