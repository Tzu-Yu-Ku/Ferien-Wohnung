image:https://github.com/st-tu-dresden-praktikum/swt20w25/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt20w25/actions"]
...
The fewodre module is a template project to bootstrap the Java project in the Software Engineering lab.
